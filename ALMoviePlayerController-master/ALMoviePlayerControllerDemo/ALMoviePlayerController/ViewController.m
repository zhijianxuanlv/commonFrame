...
- (void)viewDidLoad
{
    ...
    NSString *httpStr = [NSString stringWithFormat:@"http://192.168.23.162:8080/app/sys/courseware/downcourseware.html?coursewareId=%@",@"3"];
    //THEN set contentURL
    [self.moviePlayer setContentURL:[NSURL URLWithString:httpStr]];
    //create the controls
